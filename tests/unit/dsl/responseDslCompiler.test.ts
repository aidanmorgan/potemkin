/**
 * Tests for the source-neutral response policy compiler (REQ-RESP-001/002/003/004).
 */
...
import {
  ...
  compileResponseMask,
  compileResponseDsl,
} from '../../../src/domain/responsePolicies.js';
import { applyPatches } from '../../../src/model/patches.js';
