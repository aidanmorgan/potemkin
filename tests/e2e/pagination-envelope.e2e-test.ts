/**
 * Pagination Envelope: verifies the engine's pagination envelope feature
 ...
 *
 * When `?limit` is absent, the engine returns the raw array as the default
 * no-limit response shape. Single-entity GETs never use the envelope.
 *
 ...
 *   - Default no-limit response shape (no limit → raw array)
 *
...
describe("Pagination Envelope (full Specmatic stack)", () => {
  let app: E2eApp;
  ...
  // ═══════════════════════════════════════════════════════════════════════════
  // Default no-limit response shape
  // ═══════════════════════════════════════════════════════════════════════════

  describe("Default no-limit response shape", () => {
