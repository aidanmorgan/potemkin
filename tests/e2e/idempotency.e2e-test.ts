/**
 * Idempotency: POST /calls with Idempotency-Key; replay returns same
 * body + X-Idempotency-Replay: true.
 *
 * Uses the public Specmatic URL so idempotency is exercised through the production transport
